...
import { BookOpenCheck, HandPlatter, ScrollText } from "lucide-react";
...
const SidebarContainer = ({ collapsed }) => {
  ...
  const navLinks = [
    ...
    {
      key: "bookings",
      icon: <BookOpenCheck size={21} strokeWidth={2} />,
      label: <Link href={"/admin/booking-management"}>Bookings</Link>,
    },
    {
      key: "services",
